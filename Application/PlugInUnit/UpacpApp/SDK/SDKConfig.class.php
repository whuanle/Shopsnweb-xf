...
interface  SDKConfig
{
    ...
    // 签名证书路径
    const SDK_SIGN_CERT_PATH = 'Application/PlugInUnit/UpacpApp/assets/EnvironmentalScience/123.pfx';
    
    // 签名证书密码
    const SDK_SIGN_CERT_PWD = 'yisu123';
    
    // 密码加密证书（这条一般用不到的请随便配）
    const SDK_ENCRYPT_CERT_PATH = 'Application/PlugInUnit/UpacpApp/assets/EnvironmentalScience/acp_prod_enc.cer';
    
    // 验签证书路径（请配到文件夹，不要配到具体文件）
    const SDK_VERIFY_CERT_DIR = 'Application/PlugInUnit/UpacpApp/assets/EnvironmentalScience/';
