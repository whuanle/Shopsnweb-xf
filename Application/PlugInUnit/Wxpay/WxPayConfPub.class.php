...
class WxPayConfPub
{
    ...
    public static $JS_API_CALL_URL = 'http://ysbg.yisu.cn/index.php/Mobile/Wxpay/new_pay';
    ...
    public static $NOTIFY_URL = 'http://ysbg.yisu.cn/index.php/Home/Nofity/pcWxNofity';
