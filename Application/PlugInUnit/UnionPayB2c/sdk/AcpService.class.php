...
class AcpService
{
	 ...
	 * @return 是否成功
	 */
	static function sign(&$params, $cert_path=SDKConfig::SDK_SIGN_CERT_PATH, $cert_pwd=SDKConfig::SDK_SIGN_CERT_PWD) {
...
eot;
	...
	static function getEncryptCertId($cert_path=SDKConfig::SDK_ENCRYPT_CERT_PATH) {
	 ...
	 * @return unknown
	 */
	static function encryptData($data, $cert_path=SDKConfig::SDK_ENCRYPT_CERT_PATH) {
	 ...
	 * @return unknown
	 */
	static function decryptData($data, $cert_path=SDKConfig::SDK_SIGN_CERT_PATH, $cert_pwd=SDKConfig::SDK_SIGN_CERT_PWD) {
	 ...
	 * @param unknown_type $params
	 */
	static function deCodeFileContent($params, $fileDirectory=SDKConfig::SDK_FILE_DOWN_PATH) {
		$logger = LogUtil::getLogger();
