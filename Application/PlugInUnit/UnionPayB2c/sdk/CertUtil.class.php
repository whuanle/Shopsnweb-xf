<?php
namespace PlugInUnit\UnionPayB2c\sdk;
...
//         $cert->certId = $certId;
    ...
    public static function getSignKeyFromPfx($certPath=SDKConfig::SDK_SIGN_CERT_PATH, $certPwd=SDKConfig::SDK_SIGN_CERT_PWD)
    {
    ...
    public static function getSignCertIdFromPfx($certPath=SDKConfig::SDK_SIGN_CERT_PATH, $certPwd=SDKConfig::SDK_SIGN_CERT_PWD)
    {
        if (!array_key_exists($certPath, CertUtil::$signCerts)) {
...
// 	    $cert->certId = $certId;
    ...
    public static function getEncryptCertId($cert_path=SDKConfig::SDK_ENCRYPT_CERT_PATH){
    ...
    public static function getEncryptKey($cert_path=SDKConfig::SDK_ENCRYPT_CERT_PATH){
        if(!array_key_exists($cert_path, CertUtil::$encryptCerts)){
            self::initEncryptCert($cert_path);
        }
    ...
    private static function initVerifyCerts($cert_dir=SDKConfig::SDK_VERIFY_CERT_DIR) {
        $logger = LogUtil::getLogger();
