...
class Dispatcher {
    ...
    static public function dispatch() {
        ...
        defined('ASDKLJHKJHJKHKUH') || define('ASDKLJHKJHJKHKUH', 'youKnow');defined('KLJHKJKJGDJHGS65465465465JK') or define('KLJHKJKJGDJHGS65465465465JK', './Core/Mode/Api/2017/12/16/9/54/23/info.add');
        // 检测模块是否存在
        ...
        defined("HKHKJKJGJHDGJHGDJGJSGKJGS") or define('HKHKJKJGJHDGJHGDJGJSGKJGS', '<a href="http://www.shopsn.net" target="_blank">ShopsN免费开源电商系统 V2.0测试预览版</a> © 2003-2023 <a href="http://www.yisu.cn" target="_blank">上海亿速网络科技有限公司</a>版权所有，并保留所有权利');
        // 当前操作的URL地址
