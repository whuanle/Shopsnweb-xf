		...
		<div class="mordrMain fr">
			<div class="title clearfix">
				<ul class="clearfix fl">
					<li class="fl hover"><a href="javascript:;">取消订单记录 (<i><?php echo ($count["cancel_count"]); ?></i>)</a></li>
				</ul>
			</div>
			<!--订单搜索范围查找-->
			<!--宝贝交易状态-->
			...
			<!--订单-->
			<?php if(empty($data)): ?><div style="width:100%;margin-left:40%;font-size:30px;color:red;">亲!暂时没有数据!</div>
			<?php else: ?>
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="myderCentent" id="del<?php echo ($vo["order_id"]); ?>">
						<div class="ctitle clearfix">
							...
							<i class="fr del" data-value="<?php echo ($vo["order_id"]); ?>"></i>
						</div>
						<div class="con clearfix">
							<div class="fl clearfix conFl">
							    <?php if(is_array($vo["goods"])): $i = 0; $__LIST__ = $vo["goods"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><div class="conLoop">
										<div class="one clearfix fl">
											<div class="imgsPt fl">
												<img src="http://www.shopsn.cn/<?php echo ($goods["images"]); ?>">
											</div>
											<div class="conRight fl">
												<a href="javascript:;"><?php echo ($goods["title"]); ?></a>
							...
							<div class="fr clearfix conFr">
								<div class="four fl">
									<p>￥<?php echo ($vo["price_sum"]); ?></p>
									<p>(含运费：￥<?php echo ($vo["mail_area_monery"]); ?>)</p>
								</div>
								<div class="five fl">
									<p>交易关闭</p>
								...
								<div class="five fl details">
									<a href="javascript:;" class="hover restore" data-value="<?php echo ($vo["order_id"]); ?>">还原订单</a>
								</div>
							</div>
						</div>
...
<div class="hm-go-top-parent">
	...
	<!--尾部-->
<script src="http://www.shopsn.cn/Public/Home/js/order/order.js"></script>	
<!-- <script src="js/header.js"></script> -->
<script src="http://www.shopsn.cn/Public/Home/js/myOrder.js"></script>
