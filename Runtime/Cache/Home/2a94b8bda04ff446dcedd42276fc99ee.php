...
<div class="home-section">
   ...
   <script>
	...
	<div class="hpTopNews clearfix">
		...
		<div class="hpTopBanner fl">
			<ul class="fl slides clearfix">
				<li class="fl"><a href="javscript:;"><img></a></li>
				<li class="fl"><a href="javscript:;"><img></a></li>
			</ul>
			<a href="javascript:;" class="left"><</a>
			<a href="javascript:;" class="right">></a>
			<div class="page">
				<input type="hidden" id="banner_url" value="<?php echo U('Index/banner');?>"/>
			</div>
		</div>
		<div class="fl hpLeftBanner">
			<div class="special-sales">
				<h2 class="clearfix">
					...
					<a href="<?php echo U('Product/ProductList',['show'=>'show','new'=>'new']);?>" class="fr">更多></a>
				</h2>
				<div class="mc">
					<ul>
						<?php if(is_array($newThrees)): $i = 0; $__LIST__ = $newThrees;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$top): $mod = ($i % 2 );++$i;?><li style="overflow: hidden;" <?php if($i==1): ?>class="active"<?php endif; ?> ><a href="<?php echo ($top["ad_link"]); ?>"><img width="284" height="115" class="lazy" src="http://www.shopsn.xyz/Public/Home/img/load1.jpg" data-original="<?php echo ($top["pic_url"]); ?>" /></a></li><?php endforeach; endif; else: echo "" ;endif; ?>

					</ul>
					<ol class="clearfix">
						<?php if(is_array($newThrees)): $i = 0; $__LIST__ = $newThrees;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$top): $mod = ($i % 2 );++$i;?><li  <?php if($i==1): ?>class="fl hover"<?php endif; if($i==2): ?>class="fl active"<?php endif; if($i==3): ?>class="fl"<?php endif; ?>>
							<?php echo ($top["title"]); ?>
			...
			<div class="jdnews">
				<h3 class="clearfix">
					<b class="fl">亿速公告</b>
					<a href="<?php echo U('Service/getAnnounceList');?>" class="fr">更多></a>
				</h3>
				<?php if(is_array($announcements)): foreach($announcements as $key=>$announce): ?><p>
						<a href="<?php echo U('Service/getAnnouDetails',array('id'=>$announce['id']));?>" class="clearfix">
							<em class="fl">[公告]</em>
								<span class="fl">
									<?php echo (msubstr($announce["title"],0,12,'utf-8',true)); ?>
								</span>
							<?php if($announce["type"] == 1): ?><span><img src="http://www.shopsn.xyz/Public/Home/img/new.gif" alt=""></span><?php endif; ?>
						</a>
	...
	<div class="home-today w">
		<div class="fl home-today-fl">
			<img src="http://www.shopsn.xyz/Public/Home/img/t-title.jpg" alt="">
			<i class="mrtj-sj"></i>
			<ol class="mrtj-tab clearfix">
				<li class="fl active">我喜欢的产品</li>
				<li class="fl" onclick="restric()">超值让利</li>
				<li class="fl">最新爆款</li>
			</ol>
		</div>
		<div class="fl home-today-fr">

			<ul class="clearfix active">
				<?php if(is_array($tuijian)): $i = 0; $__LIST__ = $tuijian;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tuijian): $mod = ($i % 2 );++$i;?><li class="fl"><a href="<?php echo ($tuijian["ad_link"]); ?>"><img height="165" width="247" class="lazy" src="http://www.shopsn.xyz/Public/Home/img/load2.jpg" data-original="<?php echo ($tuijian["pic_url"]); ?>" alt=""></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
			<ul class="clearfix">
				<?php if(is_array($restric)): $i = 0; $__LIST__ = $restric;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$restric): $mod = ($i % 2 );++$i;?><li class="fl"><a href="<?php echo ($restric["ad_link"]); ?>"><img height="165" width="247" class="lazy" src="http://www.shopsn.xyz/Public/Home/img/load2.jpg" data-original="<?php echo ($restric["pic_url"]); ?>" alt=""></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
			<ul class="clearfix">
				<?php if(is_array($newTop)): $i = 0; $__LIST__ = $newTop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newTop): $mod = ($i % 2 );++$i;?><li class="fl"><a href="<?php echo ($newTop["ad_link"]); ?>"><img height="165" width="247" class="lazy" src="http://www.shopsn.xyz/Public/Home/img/load2.jpg" data-original="<?php echo ($newTop["pic_url"]); ?>" alt=""></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
			<ul class="clearfix">
				<li class="fl"><a href="javascript:;"><img class="lazy" src="http://www.shopsn.xyz/Public/Home/img/load2.jpg"  alt=""></a></li>
				<li class="fl"><a href="javascript:;"><img class="lazy" src="http://www.shopsn.xyz/Public/Home/img/load2.jpg"  alt=""></a></li>
				<li class="fl"><a href="javascript:;"><img class="lazy" src="http://www.shopsn.xyz/Public/Home/img/load2.jpg"  alt=""></a></li>
				<li class="fl"><a href="javascript:;"><img class="lazy" src="http://www.shopsn.xyz/Public/Home/img/load2.jpg"  alt=""></a></li>
				<!--data-original="img/con_four.jpg" 删除-->
			</ul>
		</div>
	</div>
	<!--1f-->
    <div id="goods_class"></div>
	</div>
	<!--左侧下楼梯菜单-->
	<div id="menu">
		<ul>
			<?php if(is_array($bigInfor)): $i = 0; $__LIST__ = $bigInfor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$big): $mod = ($i % 2 );++$i;?><li><?php echo ($big["class_name"]); ?><span><?php echo ($big["class_name"]); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
	</div>
    <input type="hidden" id="loading" value="http://www.shopsn.xyz"/>
    <script src="//cdn.bootcss.com/jquery_lazyload/1.9.7/jquery.lazyload.min.js"></script>
    <script src="http://www.shopsn.xyz/Public/Home/js/index.js"></script>
    <script>
        var goodsClassUrl = "<?php echo U('getGoodsClass');?>";//获取分类接口(原)
        var newGoodsClassUrl = "<?php echo U('IndexClass/getGoodsClass');?>";//获取分类接口(新)

        var ProductListUrl = "<?php echo U('Product/ProductList');?>";
        var BrandListUrl = "<?php echo U('Brand/index');?>";
        var goodsDetailsUrl = "<?php echo U('Goods/goodsDetails');?>";
    </script>
    <script src="http://www.shopsn.xyz/Public/Home/js/indexScroll.js"></script>
