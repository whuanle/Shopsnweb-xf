...
<script>
    ...
    <dd>
		...
		<!--内容-->
		<div class="mordrMain fr coupn-content-wrap">
			<div class="title clearfix">
				<ul class="clearfix fl nav">
					<li class="fl hover"><a href="javascript:;">可用优惠券(<i><?php echo ($usable["count"]); ?></i>)</a></li>
					<li class="fl"><a href="javascript:;">已用优惠券(<i><?php echo ($used["count"]); ?></i>)</a></li>
					<li class="fl active"><a href="javascript:;">已过期优惠券(<i><?php echo ($overdue["count"]); ?></i>)</a></li>
				</ul>
			</div>
			<div>
				<ul class="content-main clearfix available active"> 
					<?php if(is_array($usable["res"])): $i = 0; $__LIST__ = $usable["res"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="fl" id="del<?php echo ($vo["id"]); ?>">
							<h2><span>¥</span><?php echo ($vo["money"]); ?></h2>
							<p class="condition">使用条件：满<?php echo ($vo["condition"]); ?>可用</p>
							<p class="timer">有效时间：<span><?php echo (date("Y.m.d",$vo["use_start_time"])); ?>至<?php echo (date("Y.m.d",$vo["use_end_time"])); ?></span></p>
							<div class="use-btn">
								<a href="javascript:;" class="btn del" value="<?php echo ($vo["id"]); ?>">删除</a>
							</div>
						</li><?php endforeach; endif; else: echo "" ;endif; ?>
					<div class="page"><?php echo ($usable["page"]); ?></div>
				</ul>
				<ul class="content-main clearfix already">
					<?php if(is_array($used["res"])): $i = 0; $__LIST__ = $used["res"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="fl" id="del<?php echo ($vo["id"]); ?>">
							<h2><span>¥</span><?php echo ($vo["money"]); ?></h2>
							<p class="condition">使用条件：满<?php echo ($vo["condition"]); ?>可用</p>
							<p class="timer">有效时间：<span><?php echo (date("Y.m.d",$vo["use_start_time"])); ?>至<?php echo (date("Y.m.d",$vo["use_end_time"])); ?></span></p>
							<div class="use-btn">
					...
					<div class="page clearfix"><?php echo ($used["page"]); ?></div>
				</ul>
				
				<ul class="content-main clearfix already">
					<?php if(is_array($overdue["res"])): $i = 0; $__LIST__ = $overdue["res"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="fl" id="del<?php echo ($vo["id"]); ?>">
							<h2><span>¥</span><?php echo ($vo["money"]); ?></h2>
							<p class="condition">使用条件：满<?php echo ($vo["condition"]); ?>可用</p>
							<p class="timer">有效时间：<span><?php echo (date("Y.m.d",$vo["use_start_time"])); ?>至<?php echo (date("Y.m.d",$vo["use_end_time"])); ?></span></p>
							<div class="use-btn">
					...
					<div class="page"><?php echo ($overdue["page"]); ?></div>
				</ul>
			</div>
		</div>
		<!--右侧一键到顶 and 客服-->
...
<div class="hm-go-top-parent">
	...
	<!--尾部-->
<script src="http://www.shopsn.cn/Public/Home/js/Coupon/coupon.js"></script>	
<!-- <script src="http://www.shopsn.cn/Public/Home/js/header.js"></script> -->
<script src="http://www.shopsn.cn/Public/Home/js/Calendar.js"></script>
<script>
    $('.coupn-content-wrap .content-main li:nth-child(3n)').addClass('active');
	var aLi = $('.coupn-content-wrap .title .nav li');
	aLi.on('click',function(){
		aLi.removeClass('hover').eq($(this).index()).addClass('hover');
		$('.coupn-content-wrap .content-main').removeClass('active').eq($(this).index()).addClass('active');
	});
</script>
