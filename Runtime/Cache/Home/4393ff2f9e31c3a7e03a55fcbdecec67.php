		...
		<div class="mordrMain fr securityS-content-wrap">
			...
			<div class="content-wrap">
				<div class="content-info">
					<h2>您的基础信息</h2>
					<ul>
						<li>手机号码：<?php echo ($data["mobile"]); ?></li>
						<li>上次登录：<?php echo (date("Y年m月d日 H:i:s",$data["last_logon_time"])); ?> （<span>不是您登录的？请立即</span><a href="<?php echo U('UserSet/password_edit');?>">更改密码</a>）</li>
					</ul>
				</div>
				<div class="content-safe">
					<h2>您的安全服务</h2>
					<dl>
					    <?php if(empty($res)): ?><dt class="clearfix">
						...
						<dt class="clearfix">
							...
							<div class="state fl">
								...
								<div class="state-high active"></div>
							</div>
							<span class="fl">高</span>
							<em class="fl">您的帐号目前没有安全隐患</em>
						</dt><?php endif; ?>
						<dd class="clearfix password">
							...
							<div class="fr right-main">
								<a href="<?php echo U('UserSet/password_edit');?>">修改</a>
							</div>
						</dd>
						<dd class="clearfix <?php if($res == null): ?>security<?php else: ?>password<?php endif; ?>">
							<div class="clearfix fl left-main">
								<em class="fl">密保问题</em>
								<span class="fl">
									是您找回登录密码的方式之一。建议您设置一个容易记住，且最不容易被他人获取的问题及答案，更有效保障设置您的密码安全。
								</span>
							</div>
							<div class="fr right-main">
								<a href="<?php echo U('UserSet/security_question');?>">设置</a>
							</div>
						</dd>
						<dd class="clearfix password">
							<div class="clearfix fl left-main">
							...
							<div class="fr right-main">
								<a href="<?php echo U('UserSet/bound_phone');?>">修改</a>
							</div>
						</dd>
					</dl>
				</div>
