...
<script>
    ...
    <dd>
		...
		<!--内容-->
		<div class="mordrMain fr advisor-content-wrap">
			<div class="title clearfix">
				<ul class="clearfix fl">
					<li class="fl active hover"><a href="javascript:;">咨询回复</a></li>
				</ul>
			</div>
			<dl class="content-main">
				<dt class="clearfix">
					<span class="fl problem">咨询问题</span>
					<span class="fr answer">咨询回复</span>
				</dt>
				<?php if(is_array($data["res"])): $i = 0; $__LIST__ = $data["res"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd class="clearfix">
						<span class="fl problem">问：<?php echo ($vo["problem"]); ?></span>
						<span class="fr answer">答：<?php echo ($vo["answer"]); ?></span>
