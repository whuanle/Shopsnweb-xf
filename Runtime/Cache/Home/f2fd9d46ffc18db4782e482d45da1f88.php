    ...
    <div class="mordrMain fr">
        <div class="title clearfix">
            <ul class="clearfix fl">
                <li class="fl hover active"><a href="javascript:;">分销记录</a></li>
            </ul>
        </div>
        <!--订单搜索范围查找-->
        ...
        <div class="balan-title clearfix">
            <div class="fl" style="width:700px;">
                <span class="fl">总分销金额：<em>￥<?php echo ($money['sum']); ?></em></span>
                <span class="fl">可提现金额：<em class="amount">￥<?php echo ($money['money']); ?></em></span>
                <span class="fl">正在提现金额：<em>￥<?php echo ($money['moneyIng']); ?></em></span>
                <span class="fl">已提现金额：<em>￥<?php echo ($money['have']); ?></em></span>
                <span class="fl">上月分销金额：<em>￥<?php echo ($money['lastmonth']); ?></em></span>
                <span class="fl">本月分销金额：<em>￥<?php echo ($money['month']); ?></em></span>
                <!--<span class="fl">可提现金额：<em>￥<?php echo ($money); ?></em></span>-->
                <!--<span class="fl"><a href="javascript:;">安全中心</a>保护账户资产安全</span>-->
            </div>
            <div class="fl" style="width:200px;">
                <!--<a href="<?php echo U('/');?>" class="fl recharge">提现</a>-->
                <a data-url="<?php echo U('withdrawal');?>"  onclick="withdrawal(this)" class="fl recharge">提现</a>
                <a data-url="<?php echo U('withdrawalList');?>"  onclick="withdrawal(this)" class="fl recharge" style="margin-left: 10px">提现记录</a>
            </div>
        </div>
        ...
        <div class="balance-detailed">
            <dl>
                <dt class="clearfix">
                    ...
                    <span class="fl deposit">金额/比例</span>
                    <span class="fl expenditure">分销等级</span>
                    <span class="fl remarks">购买用户</span>
                </dt>
                <?php if(empty($data)): ?><dd align="center" style="color:red;margin-top:10px;">暂时没有记录!</dd>
                <?php else: ?>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd class="clearfix">
                            <span class="fl timer"><?php echo (date('Y-m-d',$vo["time"])); ?></span>
                            <span class="fl deposit"><?php echo ($vo["price"]); ?>/<?php echo ($vo["proportion"]); ?></span>
                            <span class="fl expenditure">￥<?php echo ($vo["lv"]); ?></span>
                            <span class="fl remarks"><?php echo ($vo["nick_name"]); ?></span>
                        </dd><?php endforeach; endif; else: echo "" ;endif; endif; ?>
            </dl>
        </div>
...
<div class="hm-go-top-parent">
    ...
    <script src="http://www.shopsn.xyz/Public/Home/js/Calendar.js"></script>
     <script src="http://www.shopsn.xyz/Public/Home/js/assets/assets.js"></script>
    <script src="http://www.shopsn.xyz/Public/Home/js/distribution.js?a=3"></script>
    <script>
