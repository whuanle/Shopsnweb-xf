...
<link rel="stylesheet" href="http://www.shopsn.xyz/Public/Home/css/Assert/recharge.css" />
...
<div class="mordrMain fr">
	<div class="title clearfix">
		<ul class="clearfix fl">
			<li class="fl hover active"><a href="javascript:;">充值</a></li>
		</ul>
	</div>
	<div class="container">
		<form onsubmit="return recharge();" action='<?php echo U("Recharge/recharge");?>'
			method='post'>

			<div class="form-group clearfix">
				<span class="fl">充值账户：</span>
				<div class="input-wrap fl">
					<span><?php echo ($userId["user_name"]); ?></span>
				</div>
			</div>
			<div class="form-group clearfix">
				...
				<div class="input-wrap fl">
					<input type="text"
						...
						onpaste="this.value=this.value.replace(/[^\d.]/g,'')" id='price'
						name='account' class="text-center">&nbsp;元
					<p class="text">请注意：支持国内主流银行储蓄卡充值，在线支付成功后，充值金额会在1分钟内到账。</p>
				</div>
			</div>
		...
		<dl class="text-wrap">
			<dt>温馨提示：</dt>
			<dd>1. 充值成功后，余额可能存在延迟现象，一般1到5分钟内到账，如有问题，请咨询客服：<?php echo ($intnet_phone); ?> 。</dd>
...
<script type="text/javascript" src="http://www.shopsn.xyz/Public/Home/js/pay/recharge.js?a=3"></script>
