		...
		<div class="mordrMain fr reqoer-content-wrap">
			<div class="title clearfix">
				<ul class="clearfix fl nav">
					<li class="fl  hover"><a href="<?php echo U('Service/return_repair');?>">返修/退换货记录</a></li>
					<li class="fl active"><a href="<?php echo U('Service/door_maintenance_record');?>">上门维修记录</a></li>
				</ul>
			</div> 
			<div class="content-main">
				<div class="already">
					<dl class="content">
						<dt class="clearfix">
							<span class="fl option">返修/退换货编号</span>
							<span class="fl option">要求</span>
							<span class="fl option">返修/退换货理由</span>
							<span class="fl option">申请时间</span>
							<span class="fl option">状态</span>
						</dt>
						<?php if(is_array($data["res"])): $i = 0; $__LIST__ = $data["res"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd class="clearfix">
								<span class="fl option"><?php echo ($vo["id"]); ?></span>
								<span class="fl option">
                                	<?php switch($vo["type"]): case "1": ?>退货<?php break;?>
                                		<?php case "2": ?>退款<?php break;?>
                                		<?php case "3": ?>上门维修<?php break; endswitch;?>	
								</span>
								<span class="fl option"><?php echo ($vo["tuihuo_case"]); ?></span>
								<span class="fl option"><?php echo (date("Y-m-d H:i;s",$vo["create_time"])); ?></span>
								<span class="fl option">
									<?php switch($vo["status"]): case "0": ?>审核中<?php break;?>
                                		...
                                		<?php case "6": ?>已撤销<?php break;?>
                                		<?php case "7": ?>维修进行中<?php break; endswitch;?>
								</span>
