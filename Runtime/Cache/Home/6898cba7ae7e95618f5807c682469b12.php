...
<div class="home-section">
   ...
   <script>
    ...
    <div class="lates-centent w">
        ...
        <div class="selected click-tab-mrap" id="selected1">
            <div class="title clearfix">
                <h3 class="fl">热卖精选</h3>
                <ul class="fl clearfix tab-pane">
                    <li class="fl hover">精选商品</li>
                    <?php if(is_array($hot_chooses)): foreach($hot_chooses as $k=>$hot_choose): ?><li class="fl"><?php echo ($k); ?></li><?php endforeach; endif; ?>

                </ul>
            </div>
            <div class="tab-content-wrap">
                <ul class="con-mian clearfix con-main">
                    <?php if($careGoods): if(is_array($careGoods)): foreach($careGoods as $key=>$careGood): ?><li class="fl">
                                    <a href="<?php echo U('Goods/goodsDetails',['id'=>$careGood['id']]);?>"><img src="<?php echo ($careGood["pic_url"]); ?>" width="230" height="231"></a>
                                    <a href="<?php echo U('Goods/goodsDetails',['id'=>$careGood['id']]);?>" class="title-t">
                                        <p><?php echo ($careGood["title"]); ?></p>

                                    </a>
                                    <span>原价：<i><?php echo ($careGood["price_market"]); ?></i></span>
                                    <div class="purchase">
                        ...
                        <?php else: ?>
                           <div class="hot-select-shop"><img src="http://www.shopsn.xyz/Public/Home/img/notimg.png" width="315" height="170"/> </div><?php endif; ?>

                </ul>
                <?php if(is_array($hot_chooses)): $i = 0; $__LIST__ = $hot_chooses;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot_choose_one): $mod = ($i % 2 );++$i;?><ul class="con-mian clearfix con-main">
                        <?php if($hot_choose_one): if(is_array($hot_choose_one)): $i = 0; $__LIST__ = $hot_choose_one;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot_choose_two): $mod = ($i % 2 );++$i;?><li class="fl">
                                    <a href="<?php echo U('Goods/goodsDetails',['id'=>$hot_choose_two['id']]);?>">
                                        <img src="<?php echo ($hot_choose_two["pic_url"]); ?>" height="230" width="230">
                                    </a>
                                    <a href="<?php echo U('Goods/goodsDetails',['id'=>$hot_choose_two['id']]);?>" class="title-t">
                                        <p><?php echo ($hot_choose_two["title"]); ?></p>
                                    </a>
                                    <span>原价：<i><?php echo ($hot_choose_two["price_market"]); ?></i></span>
                                    <div class="purchase">
                                        <b>¥</b><?php echo ($hot_choose_two["price_member"]); ?>
                                        <a href="<?php echo U('Goods/goodsDetails',['id'=>$hot_choose_two['id']]);?>">
                                            <a href="<?php echo U('Goods/goodsDetails',['id'=>$hot_choose_two['id']]);?>"><span>购买</span></a>
                                        </a>
                                    </div>
        ...
        <!--广告图-->
        <div class="adt">
            <?php if(is_array($lastPro_ads)): foreach($lastPro_ads as $key=>$last_ad): ?><a href="javascript:;">
                    <img src="<?php echo ($last_ad["pic_url"]); ?>">
                </a><?php endforeach; endif; ?>
            <span class="delete"></span>
        </div>
        <!--人气特卖-->
        <div class="selected click-tab-mrap" id="selected2">
            <div class="title clearfix">
                <h3 class="fl">人气特卖</h3>
                <ul class="fl clearfix tab-pane">
                    <li class="fl hover">特卖推荐</li>
                    <?php if(is_array($popular_sales)): foreach($popular_sales as $k=>$popular_sale): ?><li class="fl"><?php echo ($k); ?></li><?php endforeach; endif; ?>
                </ul>
            </div>
            <div class="tab-content-wrap">
                <ul class="con-mian clearfix con-main">
                      <?php if($sale_recos): if(is_array($sale_recos)): foreach($sale_recos as $key=>$sale_reco): ?><li class="fl">
                                  <a href="<?php echo U('Goods/goodsDetails',['id'=>$sale_reco['id']]);?>"><img src="<?php echo ($sale_reco["pic_url"]); ?>" width="230" height="231"></a>
                                  <a href="<?php echo U('Goods/goodsDetails',['id'=>$sale_reco['id']]);?>" class="title-t">
                                      <p><?php echo ($sale_reco["title"]); ?></p>
                                  </a>
                                  <span>原价：<i><?php echo ($sale_reco["price_market"]); ?>元</i></span>
                                  <div class="purchase">
                                      <b>¥</b><?php echo ($sale_reco["price_market"]); ?>
                                      <a href="<?php echo U('Goods/goodsDetails',['id'=>$sale_reco['id']]);?>"><span>购买</span></a>
                                  </div>
                              </li><?php endforeach; endif; ?>
                          <?php else: ?>
                ...
                <?php if(is_array($popular_sales)): $i = 0; $__LIST__ = $popular_sales;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$popular_sale_one): $mod = ($i % 2 );++$i;?><ul class="con-mian clearfix con-main">
                        <?php if($popular_sale_one): if(is_array($popular_sale_one)): $i = 0; $__LIST__ = $popular_sale_one;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$popular_sale_two): $mod = ($i % 2 );++$i;?><li class="fl">
                                            <a href="<?php echo U('Goods/goodsDetails',['id'=>$popular_sale_two['id']]);?>">
                                                <img src="<?php echo ($popular_sale_two["pic_url"]); ?>" height="230" width="230">
                                            </a>
                                            <a href="<?php echo U('Goods/goodsDetails',['id'=>$popular_sale_two['id']]);?>" class="title-t">
                                                <p><?php echo ($popular_sale_two["title"]); ?></p>
                                            </a>
                                            <span>原价：<i><?php echo ($popular_sale_two["price_market"]); ?></i></span>
                                            <div class="purchase">
                                                <b>¥</b><?php echo ($popular_sale_two["price_member"]); ?>
                                                <a href="<?php echo U('Goods/goodsDetails',['id'=>$popular_sale_two['id']]);?>">
                                                    <span>购买</span>
                                                </a>
                                            </div>
    ...
    <script src="http://www.shopsn.xyz/Public/Home/js/xuanxk.js"></script>
