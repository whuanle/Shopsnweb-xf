...
<script>
    ...
    <link rel="stylesheet" href="http://www.shopsn.xyz/Public/Home/css/distribution.css">
</head>
<body>
<div class="title clearfix4>
    <ul class="clearfix fl">
        <a href="javascript:;">我的团队</a>
    </ul>
    <div class="menuTree">
        <div><?php echo ($p_name); ?> -</div>
        <div>自己 -</div>
        <div>
            <div class="list">
                <?php if(empty($data)): ?><span class="menu">暂无数据</span><?php endif; ?>
                <?php if(is_array($data)): foreach($data as $key=>$item): ?><span class="menu" data-status="0" data-id="<?php echo ($item["id"]); ?>"><?php echo ($item["nick_name"]); ?></span><?php endforeach; endif; ?>
            </div>
        </div>
    </div>
</div>
...
<div class="hm-go-top-parent">
    ...
    <script src="http://www.shopsn.xyz/Public/Home/js/distribution.js"></script>
