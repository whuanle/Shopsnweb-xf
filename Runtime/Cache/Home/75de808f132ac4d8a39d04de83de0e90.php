   ...
   <script>
    ...
    <div class="lates-centent w">
        ...
        <div class="work-centent-main">
            <h2 class="title">硬件推荐</h2>
            <div class="content-main clearfix">
                <div class="fl main-left">
                    <img src="http://www.shopsn.xyz<?php echo ($hardware_pic); ?>" alt="">
                    <dl class="clearfix">
                        <dt class="fl">热门搜索</dt>
                ...
                <div class="fr main-right click-tab-mrap">
                    <div class="nav clearfix">
                        <ol class="fl clearfix life-use-rec-title tab-pane">
                            ...
                            <?php if(is_array($hardware_others)): foreach($hardware_others as $k=>$hardware_other): ?><li class="fl"><?php echo ($k); ?></li><?php endforeach; endif; ?>
                        </ol>
                        <a href="javascript:;" class="fr">查看更多 ></a>
                    </div>
                    <div class="life-use-rec-content tab-content-wrap">
                        <ul class="content clearfix con-main">
                            <?php if(is_array($hardware_all)): foreach($hardware_all as $key=>$hardware_all_child): ?><li class="fl">
                                    <div class="screenshot">
                                        <a href="<?php echo U('Goods/goodsDetails',['id'=>$hardware_all_child['id']]);?>"><img src="http://www.shopsn.xyz/<?php echo ($hardware_all_child['pic_url']); ?>"></a>
                                    </div>
                                    <p class="products-description"><a href="<?php echo U('Goods/goodsDetails',['id'=>$hardware_all_child['id']]);?>"><?php echo ($hardware_all_child['title']); ?></a></p>
                                    <i class="products-prices">¥<?php echo ($hardware_all_child['price_market']); ?></i>
                                </li><?php endforeach; endif; ?>
                        </ul>
                        <?php if(is_array($hardware_others)): foreach($hardware_others as $key=>$hardware_other): ?><ul class="content clearfix con-main">
                                <?php if(is_array($hardware_other)): foreach($hardware_other as $key=>$hardware_other_child): ?><li class="fl">
                                        <div class="screenshot">
                                            <a href="<?php echo U('Goods/goodsDetails',['id'=>$hardware_other_child['id']]);?>"><img src="http://www.shopsn.xyz<?php echo ($hardware_other_child['pic_url']); ?>"></a>
                                        </div>
                                        <p class="products-description"><a href="<?php echo U('Goods/goodsDetails',['id'=>$hardware_other_child['id']]);?>"><?php echo ($hardware_other_child['title']); ?></a></p>
                                        <i class="products-prices">¥<?php echo ($hardware_other_child['price_market']); ?></i>
                                    </li><?php endforeach; endif; ?>
                ...
                <div class="best-sellers-choose tab-content-wrap">
                    ...
                    <?php if(is_array($hot_selects)): foreach($hot_selects as $key=>$hot_select_one): ?><ul class="con-mian clearfix con-main">
                            <?php if($hot_select_one): if(is_array($hot_select_one)): foreach($hot_select_one as $key=>$hot_select_two): ?><li class="fl">
                                            ...
                                            <a href="javascript:;" class="title-t">
