...
<script>
	...
	<div class="person-section clearfix">
		...
		<!--内容-->
		<div class="mordrMain fr webauc-content-wrap">
			<div class="title clearfix">
				<ul class="clearfix fl nav">
					<li class="fl active hover"><a href="javascript:;">网站公告</a></li>
				</ul>
			</div>
			<div class="content-main">
				<ul class="con">
				    <?php if(is_array($data["res"])): $i = 0; $__LIST__ = $data["res"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Service/announcement_details',array('id'=>$vo['id']));?>">
							<li class="clearfix">
								<span class="fl">· <?php echo ($vo["title"]); ?></span>
								<span class="fr"><?php echo (date("Y-m-d",$vo["create_time"])); ?></span>
							</li>
