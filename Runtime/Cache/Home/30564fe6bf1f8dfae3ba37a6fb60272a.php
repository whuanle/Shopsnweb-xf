   ...
   <script>
    ...
    <div class="lates-centent w">
        ...
        <div class="work-centent-main">
            <h2 class="title">生活用品推荐</h2>
            <div class="content-main clearfix">
                <div class="fl main-left">
                    <img src="http://www.shopsn.xyz<?php echo ($lifeuse_pic); ?>" alt="">
                    <dl class="clearfix">
                        <dt class="fl">热门搜索</dt>
                        <dd class="fl"><a href="javascript:;">订书机</a></dd>
                        <dd class="fl"><a href="javascript:;">计算机</a></dd>
                        <dd class="fl"><a href="javascript:;">胶水</a></dd>
                        <dd class="fl"><a href="javascript:;">订书机</a></dd>
                        <dd class="fl"><a href="javascript:;">计算机</a></dd>
                        <dd class="fl"><a href="javascript:;">胶水</a></dd>
                        <dd class="fl"><a href="javascript:;">订书机</a></dd>
                ...
                <div class="fr main-right click-tab-mrap">
                    <div class="nav clearfix">
                        <ol class="fl clearfix life-use-rec-title tab-pane">
                            <li class="fl active"><img src="../images/d_15.png">全部</li>
                            <?php if(is_array($lifeuse_others)): foreach($lifeuse_others as $k=>$lifeuse_other): ?><li class="fl"><?php echo ($k); ?></li><?php endforeach; endif; ?>
                        </ol>
                        <a href="javascript:;" class="fr">查看更多 ></a>
                    </div>
                    <div class="life-use-rec-content tab-content-wrap">
                        <ul class="content clearfix con-main">
                            <?php if(is_array($lifeuse_all)): foreach($lifeuse_all as $key=>$lifeuse_all_child): ?><li class="fl">
                                    <a href="<?php echo U('Goods/goodsDetails',['id'=>$lifeuse_all_child['id']]);?>">
                                        <div class="screenshot">
                                            <img src="http://www.shopsn.xyz/<?php echo ($lifeuse_all_child['pic_url']); ?>">
                                        </div>
                                        <p class="products-description"><?php echo ($lifeuse_all_child['title']); ?></p>
                                        <i class="products-prices">¥<?php echo ($lifeuse_all_child['price_market']); ?></i>
                                    </a>
                                </li><?php endforeach; endif; ?>
                        </ul>
                         <?php if(is_array($lifeuse_others)): foreach($lifeuse_others as $key=>$lifeuse_other): ?><ul class="content clearfix con-main">
                                 <?php if(is_array($lifeuse_other)): foreach($lifeuse_other as $key=>$lifeuse_other_child): ?><li class="fl">
                                         <a href="<?php echo U('Goods/goodsDetails',['id'=>$lifeuse_other_child['id']]);?>">
                                             <div class="screenshot">
                                                 <img src="http://www.shopsn.xyz<?php echo ($lifeuse_other_child['pic_url']); ?>">
                                             </div>
                                             <p class="products-description"><?php echo ($lifeuse_other_child['title']); ?></p>
                                             <i class="products-prices">¥<?php echo ($lifeuse_other_child['price_market']); ?></i>
                                         </a>
                                     </li><?php endforeach; endif; ?>
        ...
        <div class="lates-content">
            <div class="selected click-tab-mrap" id="selected1">
                <div class="title clearfix">
                    <h3 class="fl">热卖精选</h3>
                    <ul class="fl clearfix best-sellers-title tab-pane">
                ...
                <div class="best-sellers-choose tab-content-wrap">
                    <ul class="con-mian clearfix con-main">
                         <?php if($careGoods): if(is_array($careGoods)): foreach($careGoods as $key=>$careGood): ?><li class="fl">
                                         <a href="<?php echo U('Goods/goodsDetails',['id'=>$careGood['id']]);?>"><img src="<?php echo ($careGood["pic_url"]); ?>" widht="230" height="230"></a>
                    ...
                    <?php if(is_array($hot_selects)): foreach($hot_selects as $key=>$hot_select_one): ?><ul class="con-mian clearfix con-main">
                            <?php if($hot_select_one): if(is_array($hot_select_one)): foreach($hot_select_one as $key=>$hot_select_two): ?><li class="fl">
                                                <a href="<?php echo U('Goods/goodsDetails',['id'=>$hot_select_two['id']]);?>"><img src="http://www.shopsn.xyz/<?php echo ($hot_select_two['pic_url']); ?>"  widht="230" height="230"></a>
