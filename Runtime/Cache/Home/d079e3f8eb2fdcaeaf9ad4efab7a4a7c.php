		...
		<div class="mordrMain fr reqoer-content-wrap">
			<div class="title clearfix">
				<ul class="clearfix fl nav">
					<li class="fl active hover"><a href="javascript:;">投诉中心</a></li>
				</ul>
			</div>
			<div class="content-main">
				<div class="already">
					<h2 class="con-title">我做出的投诉</h2>
					<dl class="content">
						<dt class="clearfix">
							<span class="fl reason">投诉原因</span>
							<span class="fl con">投诉内容</span>
							<span class="fl timer">发起时间</span>
						</dt>
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd class="clearfix">
								<span class="fl reason"><?php echo ($vo["reason"]); ?></span>
								<span class="fl con"><?php echo (substr($vo["content"],0,120)); ?></span>
