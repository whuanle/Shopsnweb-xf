		...
		<div class="mordrMain fr punke-content-wrap">
			<div class="title clearfix">
				...
				<dl class="clearfix fr nav">
					...
					<dd class="fl"><a href="<?php echo U('Assets/punkte_ajax',array('flag'=>1));?>">0-1000</a></dd>
					<dd class="fl"><a href="<?php echo U('Assets/punkte_ajax',array('flag'=>2));?>">1000-2000</a></dd>
					<dd class="fl"><a href="<?php echo U('Assets/punkte_ajax',array('flag'=>3));?>">2000-3000</a></dd>
					<dd class="fl"><a href="<?php echo U('Assets/punkte_ajax',array('flag'=>4));?>">3000-5000</a></dd>
					<dd class="fl"><a href="<?php echo U('Assets/punkte_ajax',array('flag'=>5));?>">5000-10000</a></dd>
					<dd class="fl"><a href="<?php echo U('Assets/punkte_ajax',array('flag'=>6));?>">10000-20000</a></dd>
					<dd class="fl none"><a href="<?php echo U('Assets/punkte_ajax',array('flag'=>7));?>">20000及以上</a></dd>
				</dl>
			</div>
			<ul class="content-main clearfix">
			    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="fl">
						<div class="screenshot">
							<img src="http://www.shopsn.cn<?php echo ($vo["images"]); ?>">
						</div>
						<div class="products-description">
							<p><?php echo (substr($vo["title"],0,81)); ?></p>
							<span><?php echo ($vo["integral"]); ?> 积分</span>
						</div>
						<div class="products-operation clearfix">
							<input type="button" value="立即兑换" class="fl search-btn" data-value="<?php echo U('IntegralMall/cart',array('goods_id'=>$vo['goods_id']));?>">
						</div>
