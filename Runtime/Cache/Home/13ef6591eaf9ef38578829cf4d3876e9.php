	...
	<div class="mcole-section-wrap w">
		<div class="nav clearfix">
			<ol class="clearfix fl">
			    <?php if($status == '0'): ?><li class="fl active"><a href="<?php echo U('Assets/myCollection');?>">全部商品<b>（<?php echo ($count); ?>）</b></a></li>
				<li class="fl"><a href="<?php echo U('Assets/collection_price');?>" class="active"> 降价商品 <b><?php echo ($price_count); ?></b></a></li>
				<?php else: ?>
				<li class="fl"><a href="<?php echo U('Assets/myCollection');?>">全部商品<b>（<?php echo ($count); ?>）</b></a></li>
				<li class="fl  active"><a href="<?php echo U('Assets/collection_price');?>" class="active"> 降价商品 <b><?php echo ($price_count); ?></b></a></li><?php endif; ?>
			</ol>
			<form action="<?php echo U('Assets/ajax_goods');?>" method="post" id="form">
		...
		<ul class="content-main clearfix">
		    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="fl" id="del<?php echo ($vo["id"]); ?>">
					<div class="screenshot">
						<a href="javascript:;"><img src="http://www.shopsn.cn<?php echo ($vo["images"]); ?>"></a>
					</div>
					<div class="products-description">
						<p><a href="javascript:;"><?php echo ($vo["title"]); ?> </a></p>
						<span class="products-prices">¥ <?php echo ($vo["price_member"]); ?></span>
					</div>

					<div class="products-operation clearfix">
						<input type="button" value="加入购物车" data-value="<?php echo ($vo["goods_id"]); ?>" class="fl search-text cart_add">
						<input type="button" name="del" value="删除" data-value="<?php echo ($vo["id"]); ?>" class="fl search-btn">
					</div>
...
<div class="hm-go-top-parent">
	...
	<!--尾部-->
<script src="http://www.shopsn.cn/Public/Home/js/assets/assets.js"></script>	
