...
<script>
    ...
    <dd>
		...
		<!--内容-->
		<div class="mordrMain fr bindcout-content-wrap">
			<div class="title clearfix">
				<ul class="clearfix fl nav">
					<li class="fl active hover"><a href="javascript:;">账号绑定</a></li>
				</ul>
			</div>
			<ul class="content-main">
				<li class='clearfix <?php if(count($list[3]) > 0): ?>active<?php endif; ?> '>
					<div class="fl clearfix">
						<span class="fl show"></span>
						<span class="fl">支付宝绑定</span>
						<span class="fl data"><?php if(empty($list[3])): ?>未绑定<?php else: ?>绑定<?php endif; ?></span>
					</div>
					<div class="fr">
						<?php if(count($list[3]) == 0): ?><a href="<?php echo U('bindAlipay', ['act'=>1]);?>">绑定</a>
 						<?php else: ?>
	 						<a href="<?php echo U('bindAlipay', ['act'=>2]);?>">解绑</a><?php endif; ?>
					</div>
				</li>
				<li class='clearfix <?php if(count($list[4]) > 0): ?>active<?php endif; ?> '>
					<div class="fl clearfix">
						<span class="fl show"></span>
						<span class="fl">QQ绑定</span>
						<span class="fl data"><?php if(empty($list[4])): ?>未绑定<?php else: ?>绑定<?php endif; ?></span>
					</div>
					<div class="fr">
						暂不支持
						<!-- <?php if(count($list[4]) == 0): ?><a href="<?php echo U('bindQQ', ['act'=>1]);?>">绑定</a>
 						<?php else: ?>
	 						<a href="<?php echo U('bindQQ', ['act'=>2]);?>">解绑</a><?php endif; ?> -->
					</div>
				</li>
				<li class='clearfix <?php if(count($list[5]) > 0): ?>active<?php endif; ?> '>
					<div class="fl clearfix">
						<span class="fl show"></span>
						<span class="fl">微信绑定</span>
						<span class="fl data"><?php if(empty($list[5])): ?>未绑定<?php else: ?>绑定<?php endif; ?></span>
					</div>
					<div class="fr">
						暂不支持
						<!-- <?php if(count($list[5]) == 0): ?><a href="<?php echo U('bindWechat', ['act'=>1]);?>">绑定</a>
 						<?php else: ?>
	 						<a href="<?php echo U('bindWechat', ['act'=>2]);?>">解绑</a><?php endif; ?> -->
					</div>
				</li>
				<li class='clearfix <?php if(count($list[6]) > 0): ?>active<?php endif; ?> '>
					<div class="fl clearfix">
						<span class="fl show"></span>
						<span class="fl">微博绑定</span>
						<span class="fl data"><?php if(empty($list[6])): ?>未绑定<?php else: ?>绑定<?php endif; ?></span>
					</div>
					<div class="fr">
						<?php if(count($list[6]) == 0): ?><a href="<?php echo U('bindWeibo', ['act'=>1]);?>">绑定</a>
 						<?php else: ?>
	 						<a href="<?php echo U('bindWeibo', ['act'=>2]);?>">解绑</a><?php endif; ?>
