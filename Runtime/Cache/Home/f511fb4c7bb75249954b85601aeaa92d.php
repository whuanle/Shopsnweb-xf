		...
		<div class="mordrMain fr otheros-content-wrap">
			<div class="title clearfix">
				<ul class="clearfix fl nav">
					<li class="fl active hover"><a href="javascript:;">我的发票--发票详细</a></li>
				</ul>
			</div>
			<div class="con-wrap clearfix">
				<ul class="con-tailed clearfix">
					<li class="fl">发票号码:  <?php echo ($data["id"]); ?></li>
					<li class="fl">开票日期:  <?php echo (date("Y-m-d",$data["billing_date"])); ?></li>
					<li class="fl">金额:  <?php echo ($data["price"]); ?></li>
					<li class="fl">客户编号:  <?php echo ($data["user_id"]); ?></li>
					<li class="fl">购货单位:  <?php echo ($data["purchase_unit"]); ?></li>
					<li class="fl">销货单位:  <?php echo ($data["sales_unit"]); ?></li>
				</ul>
				<table class="content-main">
					...
					<?php if(is_array($goods)): $key = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr>
							<td class="w60"><?php echo ($key); ?></td>
							<td class="w110"><?php echo ($vo["goods_id"]); ?></td>
							<td class="w280"><?php echo ($vo["title"]); ?></td>
							<td class="w80">
								<?php if(is_array($vo["space"])): $i = 0; $__LIST__ = $vo["space"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$space): $mod = ($i % 2 );++$i; echo ($space["item"]); endforeach; endif; else: echo "" ;endif; ?>
							</td>
							<td class="w50"><?php echo ($vo["goods_company"]); ?></td>
							<td class="w80"><?php echo ($vo["goods_num"]); ?></td>
							<td class="85"><?php echo ($vo["goods_price"]); ?></td>
							<td class="85"><?php echo ($vo["goods_price_num"]); ?></td>
							<td class="85"><?php echo ($vo["goods_tax_rate"]); ?></td>
							<td class="85"><?php echo ($vo["goods_tax"]); ?></td>
