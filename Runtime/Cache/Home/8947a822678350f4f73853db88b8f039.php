...
<script>
    ...
    <dd>
		...
		<div class="mordrMain fr personaM-content-wrap">
			...
			<form action="<?php echo U('UserData/user_data');?>" method="post" onsubmit="return user_data()">
				<dl class="content-main">
					<dt>亲爱的 <?php echo ($data["nick_name"]); ?>，填写真实的资料，有助于好友找到你哦。</dt>
					<dd class="clearfix">
						<span class="fl">当前头像：</span>
						<div class="fl img-parent">
							
							<?php if(!empty($data["user_header"])): ?><a href="<?php echo U('UserData/head_edit');?>">  
									<img src="<?php echo ($data["user_header"]); ?>" height="83" widht="83">
								</a>
							<?php else: ?>
								<a href="<?php echo U('UserData/head_edit');?>">
									暂时没有头像!
								</a><?php endif; ?>
					...
					<dd class="clearfix">
						...
						<input type="text" value="<?php echo ($data["nick_name"]); ?>" class="txt fl" name="nick_name" id="nick_name">
					</dd>
					<dd class="clearfix">
						<span class="fl">真实姓名：</span>
						<input type="text" value="<?php echo ($data["user_name"]); ?>" class="txt fl" name="user_name" id="user_name">
					</dd>
					<dd class="clearfix">
						<span class="fl">手机号码：</span>
						<input type="text" value="<?php echo ($data["mobile"]); ?>" class="txt fl" name="mobile" id="mobile">
					</dd>
					<dd class="clearfix">
						<span class="fl">邮箱：</span>
						<input type="text" value="<?php echo ($data["email"]); ?>" class="txt fl" name="email" id="email">
					</dd>
					<dd class="clearfix">
						<span class="fl">性别：</span>
						<label class="fl sex"><input type="radio" name="sex" value="男"<?php if($data["sex"] == '男'): ?>checked<?php endif; ?>>男</label>
						<label class="fl sex"><input type="radio" name="sex" value="女"<?php if($data["sex"] == '女'): ?>checked<?php endif; ?>>女</label>
					</dd>
					<dd class="clearfix">
						<span class="fl"></span>
...
<div class="hm-go-top-parent">
	...
	<!--尾部-->
<script src="http://www.shopsn.cn/Public/Home/js/userset/user_data.js"></script>
