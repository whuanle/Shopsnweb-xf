				...
				<ul class="clearfix">
					<li class="fl">
						<div class="WeChat-img">
							<a href="<?php echo U('Service/repair_ys');?>">
								<img src="http://www.shopsn.cn/Public/Home/img/w44.jpg">
								<img src="http://www.shopsn.cn/Public/Home/img/d8.png" class="move">
							</a>
							<p>商城商品维修</p>
						</div>
					</li>
					<li class="fl">
						<div class="WeChat-img">
							<a href="<?php echo U('Service/repair');?>">
								<img src="http://www.shopsn.cn/Public/Home/img/w45.jpg">
								<img src="http://www.shopsn.cn/Public/Home/img/d7.png" class="move">
							</a>
							<p>非商城商品维修</p>
						</div>
					</li>
...
<!-- <script src="js/header.js"></script> -->
    <script>
		//划入效果
		$('.repair-content-main .link .WeChat-img a').on('mouseenter mouseleave',function(e){
			var w = $(this).width(); 
			var h = $(this).height(); 
			...
			var aPos=[{left:0,top:-136},{left:118,top:0},{left:0,top:136},{left:-118,top:0}];
			if(eventType == 'mouseenter'){
				$(this).find('.move').css(aPos[direction]).stop(true,true).animate({left:0,top:0},200);
			}else{
				$(this).find('.move').stop(true,true).animate(aPos[direction],200);    
			}
		});
	</script>
	</script>
