...
<script src="http://www.shopsn.xyz/Public/Common/uploadify/jquery.min.js" type="text/javascript"></script>
<!--防止客户端缓存文件，造成uploadify.js不更新，而引起的“喔唷，崩溃啦”-->
<script>document.write("<script type='text/javascript' "+ "src='http://www.shopsn.xyz/Public/Common/uploadify/jquery.uploadify.js?" + new Date()+ "'></s" + "cript>");
</script>
<script src="http://www.shopsn.xyz/Public/Common/uploadify/uploadify-move.js" type="text/javascript"></script>
<script type="text/javascript">
	...
	$(function() {
		$('#uploadify').uploadify({
				...
				'method'   		  : 'post',
				'multi'   		  : true,
				'swf'      		  : 'http://www.shopsn.xyz/Public/Common/uploadify/uploadify.swf',
	...
	function SetImgContent(data){
		...
		if(obj.state == 'SUCCESS'){
			var sLi = "";
			sLi += '<li class="img">';
			sLi += '<img src="' + obj.url + '" width="100" height="100" onerror="this.src=\'http://www.shopsn.xyz/Public/Common/uploadify/nopic.png\'">';
	...
	$("#SaveBtn").click(function(){
		...
		if(callback != "undefined"){
			...
			var code = 'window.parent.'+callback+'(fileurl_tmp, elementID)';
			eval(code);
