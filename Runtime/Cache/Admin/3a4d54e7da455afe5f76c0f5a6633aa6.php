...
<link rel="stylesheet"
 ...
 <div id="explanation" class="explanation">
    ...
    <div class="nav">
        <div class="nav_title">
            <h4><img class="nav_img" src="http://www.shopsn.xyz/Public/Admin/img/tab.gif" /><span class="nav_a">商品类型列表</span></h4>
        </div>
        <div class="nav_button">
            <a href="<?php echo U('add');?>"><button class="button">+ 添加商品类型</button></a>
        </div>
    </div>
    <br/><br/>
